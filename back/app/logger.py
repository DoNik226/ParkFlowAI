...
class EventLogger:
    ...
    def log_camera_connected(self, camera_id: int, parking_id: int | None = None) -> None:
        self.log(
    ...
    def log_camera_connection_restored(self, camera_id: int, parking_id: int | None = None) -> None:
        self.log(
            event_type=EventType.CAMERA_CONNECTION_RESTORED.value,
            description="Соединение с камерой восстановлено",
            entity_type=EventEntityType.CAMERA.value,
            entity_id=camera_id,
            parking_id=parking_id,
        )
...
class AuditLogger(EventLogger):
    def log_user_login(self, user_id: int, entity_type: str = EventEntityType.USER.value) -> None:
        self.log(
    ...
    def log_user_logout(self, user_id: int, entity_type: str = EventEntityType.USER.value) -> None:
        self.log(
    ...
    def log_admin_action(
        ...
        *,
        ...
        self.log(
            ...
            description=description,
            entity_type=entity_type,
            entity_id=entity_id or admin_user_id,
